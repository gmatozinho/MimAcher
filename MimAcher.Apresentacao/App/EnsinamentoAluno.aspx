<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnsinamentoAluno.aspx.cs" MasterPageFile="~/Site.Master" Inherits="MimAcher.Apresentacao.App.EnsinamentoAluno" %>
...
<%-- Window --%>
    <ext:Window ID="EnsinamentoAlunoWindowId" Width="400" Height="290" Modal="true" runat="server" Hidden="true">
        <Items>

        <%-- Form --%>
        <ext:FormPanel ID="EnsinamentoAlunoFormPanelId" runat="server" Title="Aluno" BodyPadding="5" ButtonAlign="Right" Layout="Column">    
                               
            <FieldDefaults LabelAlign="Left" MsgTarget="Side" Size="100" AllowBlank="false" />
                                                        
            <Items> 
            
                <ext:FieldSet ID="EnsinamentoAlunoFieldSetId" runat="server" Title="Aluno" MarginSpec="0 0 0 10">                                                      
                    <Defaults>
                    ...
                    <Items>
                        ...
                        <ext:ComboBox ID="cod_eId" Width="300" Name="cod_e" AllowBlank="false" runat="server" FieldLabel="Aprende" ValueField="cod_e_combo" DisplayField="nome_combo">
                            <Store>
                                <ext:Store ID="StoreEnsinamentoId" runat="server">
                                    <Model>
                                        <ext:Model ID="ModelEnsinamentoId" runat="server">
                                            <Fields>
    ...
    <%-- Store da Grid --%>
    <Store>
        <ext:Store ID="StoreEnsinamentoAlunoId" runat="server" PageSize="31" OnReadData="List" RemoteSort="true" AutoLoad="true">
            <Model>
                <ext:Model ID="ModelEnsinamentoAlunoId" runat="server" IDProperty="cod_ae">
                    <Fields>
 ...
 <ext:GridPanel 
        ...
        <SelectionModel>
            <ext:RowSelectionModel ID="EnsinamentoAlunoRowSelectionModelId" Mode="Single" runat="server" >
                    <Listeners>                        
                        <Select Handler="#{EnsinamentoAlunoFormPanelId}.getForm().loadRecord(record); 
                ...
                <Items>
                    ...
                    <ext:Button ID="EditButtonId" runat="server" Text="Editar" Icon="PageEdit" Disabled="true" >
                        <DirectEvents>
                            <Click OnEvent="Edit">
                                <ExtraParams>
                                    <ext:Parameter Name="RecordGrid" Mode="Raw" Value="#{AlunoGridPanelId}.getRowsValues({selectedOnly : true})[0].cod_ae" />                                
                                </ExtraParams>
                            </Click>
                        </DirectEvents>
                    </ext:Button>
