...
namespace MimAcher.Apresentacao.App
{
    public partial class EnsinamentoAluno : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!X.IsAjaxRequest)
            {
                this.StoreEnsinamentoAlunoId.DataSource = this.GestorDeEnsinoDeAluno.ObterTodosOsRegistros().OrderBy(l => l.MA_ENSINAR.nome);
                this.StoreEnsinamentoAlunoId.DataBind();

                this.StoreAlunoId.DataSource = this.GestorDeAluno.ObterTodosOsAlunos().OrderBy(l => l.nome);
                this.StoreAlunoId.DataBind();

                this.StoreEnsinamentoId.DataSource = this.GestorDeEnsinar.ObterTodosOsRegistrosDoQueSePodeEnsinado().OrderBy(l => l.nome);
                this.StoreEnsinamentoId.DataBind();
            }
        }
        ...
        {
            this.EnsinamentoAlunoWindowId.Show();
        }
        ...
        protected void Save(object sender, DirectEventArgs e)
        {
            ...
            if (this.cod_aeId.Text == "")
            {
                ...
                this.EnsinamentoAlunoWindowId.Close();
                this.LimpaForm();
            }
