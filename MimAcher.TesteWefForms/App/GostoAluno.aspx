<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GostoAluno.aspx.cs" MasterPageFile="~/Site.Master" Inherits="MimAcher.TesteWefForms.App.GostoAluno" %>
...
<%-- Window --%>
    <ext:Window ID="GostoAlunoWindowId" Width="400" Height="290" Modal="true" runat="server" Hidden="true">
        ...
        <%-- Form --%>
        <ext:FormPanel ID="GostoAlunoFormPanelId" runat="server" Title="Aluno" BodyPadding="5" ButtonAlign="Right" Layout="Column">    
                               
            <FieldDefaults LabelAlign="Left" MsgTarget="Side" Size="100" AllowBlank="false" />
                                                        
            <Items> 
            
                <ext:FieldSet ID="GostoAlunoFieldSetId" runat="server" Title="Aluno" MarginSpec="0 0 0 10">                                                      
                    <Defaults>
                    ...
                    <Items>
                        ...
                        <%-- Código do Gosto do Aluno --%>
                        <ext:TextField ID="cod_agId" Name="cod_ag"  runat="server" FieldLabel="Código" />
                        ...
                        <%-- Combobox do Gosto --%>
                        <ext:ComboBox ID="cod_gId" Width="300" Name="cod_g" AllowBlank="false" runat="server" FieldLabel="Aprende" ValueField="cod_g_combo" DisplayField="nome_combo">
                            <Store>
                                <ext:Store ID="StoreGostoId" runat="server">
                                    <Model>
                                        <ext:Model ID="ModelGostoId" runat="server">
                                            <Fields>
                                                <ext:ModelField Name="cod_g_combo" Mapping="cod_g" />
    ...
    <%-- Store da Grid --%>
    <Store>
        <ext:Store ID="StoreGostoAlunoId" runat="server" PageSize="31" OnReadData="List" RemoteSort="true" AutoLoad="true">
            <Model>
                <ext:Model ID="ModelGostoAlunoId" runat="server" IDProperty="cod_ag">
                    <Fields>
 ...
 <%-- Grid --%> 
 <ext:GridPanel 
        ID="GostoAlunoGridPanelId"
        runat="server" 
        Title="Gerenciamento de Gosto"
        StoreID="StoreGostoAlunoId">         
        
        <%-- Colunas da Grid --%>
        <ColumnModel>
            <Columns>
                <ext:Column ID="cod_agColumnId" runat="server" Text="Código" DataIndex="cod_ag" Visible="false" />
        ...
        <SelectionModel>
            <ext:RowSelectionModel ID="GostoAlunoRowSelectionModelId" Mode="Single" runat="server" >
                    <Listeners>                        
                        <Select Handler="#{GostoAlunoFormPanelId}.getForm().loadRecord(record); 
