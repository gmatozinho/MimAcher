<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ensinar.aspx.cs"  MasterPageFile="~/Site.Master" Inherits="MimAcher.TesteWefForms.App.Ensinar" %>
...
<%-- Window --%>
    <ext:Window ID="EnsinarWindowId" Width="400" Height="290" Modal="true" runat="server" Hidden="true">
        <Items>
