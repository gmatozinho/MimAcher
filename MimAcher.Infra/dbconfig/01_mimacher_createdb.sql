...
ALTER TABLE MA_PARTICIPANTE_ENSINAR ADD CONSTRAINT FK_MA_PARTICIPANTE_APRENDER_MA_STATUS_RELACAO_cod_s_relacao FOREIGN KEY (cod_s_relacao) REFERENCES MA_STATUS_RELACAO(cod_s_relacao);
